...
const CardOthersExperiences = ({ img, link1 }) => {
    console.log("Esto es un link", link1);
    return (
        <div className='w-[100%]'>
                        ...
                        <div className="mt-1 max-w-sm mx-auto">
                            <div className="relative group">
                                ...
                                <div className="absolute bottom-0 left-0 p-4">
                                    <h1 className="text-white font-bold text-lg">Sitio de interés</h1>
                                </div>
...
export default CardOthersExperiences