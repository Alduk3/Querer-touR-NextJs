                    ...
                    <div className="container">
                        ...
                        <div className="mt-1 max-w-sm mx-auto">
                            <div className="relative group">
                                <img
                                    src={img}
                                    alt="Photo by Sébastien Goldberg on Unsplash" className="h-[300px] w-[600px] rounded shadow-xl hover:shadow-2xl" />
                                <div
